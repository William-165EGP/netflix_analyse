...
print("6. 類型策略：從圓餅圖看出Netflix電影數量比例超過電視劇")
print("7. 時長特徵：電影時長主要集中在90-120分鐘區間")
print("8. 分級策略：成人分級內容（TV-MA, R）發行年份相對較新")
print("9. 內容主題：從文字雲可見 'young', 'new', 'life', 'find' 等是高頻詞彙")
